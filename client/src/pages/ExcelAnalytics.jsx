...
const ExcelAnalytics = () => {
  ...
  const downloadAsPNG = async () => {
    ...
    try {
      ...
      const baseName =
        customFilename?.trim() ||
        `${selectedYAxis}_vs_${selectedXAxis}` ||
        "chart";
  ...
  const renderChart = () => {
    ...
    if (
      ...
      return (
        <div className="text-gray-500 text-center">No data to display.</div>
      );
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <ReactSelect
                  ...
                  value={selectOptions.find(
                    (opt) => opt.value === selectedXAxis
                  )}
                  onChange={(selectedOption) =>
                    setSelectedXAxis(selectedOption.value)
                  }
              ...
              <div>
                ...
                <ReactSelect
                  options={selectOptions}
                  value={selectOptions.find(
                    (opt) => opt.value === selectedYAxis
                  )}
                  onChange={(selectedOption) =>
                    setSelectedYAxis(selectedOption.value)
                  }
                  className="react-select-container text-sm"
                  classNamePrefix="react-select"
                  styles={{
